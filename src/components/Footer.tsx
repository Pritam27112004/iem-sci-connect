      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="animate-fade-in" style={{ animationDuration: '0.6s' }}>
            <h3 className="text-lg font-semibold mb-4 text-transparent bg-gradient-to-r from-white to-iem-light bg-clip-text">IEM-Sci-Connect</h3>
          ...
          <div className="animate-fade-in" style={{ animationDuration: '0.6s', animationDelay: '0.2s' }}>
            <h3 className="text-lg font-semibold mb-4 text-transparent bg-gradient-to-r from-white to-iem-light bg-clip-text">Quick Links</h3>
            <ul className="space-y-2 text-sm opacity-80">
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/" className="hover:text-iem-accent transition-colors">Home</Link>
              </li>
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/faculty" className="hover:text-iem-accent transition-colors">Faculty Directory</Link>
              </li>
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/leaderboard" className="hover:text-iem-accent transition-colors">Student Leaderboard</Link>
              </li>
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/about" className="hover:text-iem-accent transition-colors">About the Department</Link>
              </li>
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/login" className="hover:text-iem-accent transition-colors">Login</Link>
              </li>
              <li className="transform hover:translate-x-1 transition-transform">
                <Link to="/register" className="hover:text-iem-accent transition-colors">Register</Link>
              </li>
            </ul>
          </div>
          
          <div className="animate-fade-in" style={{ animationDuration: '0.6s', animationDelay: '0.4s' }}>
            <h3 className="text-lg font-semibold mb-4 text-transparent bg-gradient-to-r from-white to-iem-light bg-clip-text">Contact Us</h3>
            <ul className="space-y-3 text-sm opacity-80">
              <li className="flex items-center transform hover:translate-x-1 transition-transform">
                <MapPin size={16} className="mr-2 text-iem-accent" />
                <span>IEM Campus, Y-12, Block-EP, Sector-V, Salt Lake, Kolkata, India</span>
              </li>
              <li className="flex items-center transform hover:translate-x-1 transition-transform">
                <Phone size={16} className="mr-2 text-iem-accent" />
                <span>+91 (033) 2357-0000</span>
              </li>
              <li className="flex items-center transform hover:translate-x-1 transition-transform">
                <Mail size={16} className="mr-2 text-iem-accent" />
